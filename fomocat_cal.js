function fomo3d() {
	...
	nowkeyprice = (0.000074999921875+0.00000000015625*totalkeypec)*2000
	endkeyprice = (0.000074999921875+0.00000000015625*(buykey+totalkeypec))*2000
	...
	buyeth=buyeth+((0.000074999921875+0.00000000015625*t))*2000;
	}
	
    document.getElementById('buyeth').value = buyeth;
	
	for(noweth=0,t=1,i=totalkeypec;i>0;i--,t++){
	noweth=noweth+((0.000074999921875+0.00000000015625*t))*2000;
	}
